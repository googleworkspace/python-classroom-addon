...
def add_iframe_query_parameters_to_session(args):
    ...
    if args.get("postId"):
        flask.session["postId"] = args.get("postId")
...
def load_activity_attachment():
    ...
    # Note that the submissionId was returned in the addOnContext response.
        ...
        submission_response = classroom_service.courses().posts(
    ...
    message_str += (
        ...
        if user_context == "teacher" else "Please complete the activity below.")
